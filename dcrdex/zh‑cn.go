...
var PtBr = map[string]string{
	...
	"add_a_base_wallet":              `Adicionar uma<br><span data-unit="base"></span><br>carteira`,
	...
	"pw_for_seed":            "Informar sua senha do aplicativo para mostrar sua Enter your app password to show your seed. Make sure nobody else can see your screen.",
	"Asset":                  "Ativo",
	"Balance":                "Balanço",
	"Actions":                "Ações",
